		...
		case "blackmarket":
	{
		switch(true) do
		{
			...
			default
			{
				["blackmarket",
					[
						["arifle_mk20_F",nil,330000],
						["arifle_TRG21_F",nil,310000],
						["30Rnd_556x45_Stanag",nil,2000],
						["optic_MRCO_F",nil,50000],
						["optic_Arco_F",nil,40000],
						["optic_Erco_blk_F",nil,40000],
						["optic_Hamr",nil,4000000],
						["V_TacVest_camo",nil,250000],
						["V_TacVest_brn",nil,250000],
						["V_TacVest_blk",nil,250000],
						["V_TacVest_oli",nil,250000],
						["V_TacVest_khk",nil,250000],
						["v_Tacvestir_blk",nil,230000],
						["U_BG_Leader",nil,10000],
